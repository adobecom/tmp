var Gr=Object.defineProperty;var Oe=o=>{throw TypeError(o)};var Vr=(o,e,t)=>e in o?Gr(o,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):o[e]=t;var l=(o,e,t)=>Vr(o,typeof e!="symbol"?e+"":e,t),de=(o,e,t)=>e.has(o)||Oe("Cannot "+t);var c=(o,e,t)=>(de(o,e,"read from private field"),t?t.call(o):e.get(o)),m=(o,e,t)=>e.has(o)?Oe("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(o):e.set(o,t),h=(o,e,t,r)=>(de(o,e,"write to private field"),r?r.call(o,t):e.set(o,t),t),w=(o,e,t)=>(de(o,e,"access private method"),t);var $e=(o,e,t,r)=>({set _(n){h(o,e,n,t)},get _(){return c(o,e,r)}});import{LitElement as pn}from"../lit-all.min.js";import{css as Ie,unsafeCSS as ze}from"../lit-all.min.js";var k="(max-width: 767px)",It="(max-width: 1199px)",b="(min-width: 768px)",u="(min-width: 1200px)",O="(min-width: 1600px)";function Dt(){return window.matchMedia(k)}function Ft(){return window.matchMedia(u)}function Ut(){return Dt().matches}function Bt(){return Ft().matches}var De=Ie`
    :host {
...
`,Fe=()=>[Ie`
      ...
      `];import{LitElement as Yr,html as Ue,css as Kr}from"../lit-all.min.js";var ot=class extends Yr{constructor(){super(),this.size="m",this.alt="",this.loading="lazy"}render(){let{href:e}=this;return e?Ue`<a href="${e}">
                  <img src="${this.src}" alt="${this.alt}" loading="${this.loading}" />
              </a>`:Ue` <img src="${this.src}" alt="${this.alt}" loading="${this.loading}" />`}};l(ot,"properties",{size:{type:String,attribute:!0},src:{type:String,attribute:!0},alt:{type:String,attribute:!0},href:{type:String,attribute:!0},loading:{type:String,attribute:!0}}),l(ot,"styles",Kr`
        :host {
            --img-width: 32px;
            --img-height: 32px;
            display: block;
...
merch-card[variant="catalog"] .payment-details {
  ...
  line-height: var(--consonant-merch-card-body-line-height);
            ...
            <slot></slot>`}getGlobalCSS(){return er}setAriaExpanded(t,r){t.setAttribute("aria-expanded",r)}connectedCallbackHook(){this.card.addEventListener("mouseleave",this.toggleActionMenuFromCard)}disconnectedCallbackHook(){this.card.removeEventListener("mouseleave",this.toggleActionMenuFromCard)}};l(dt,"variantStyle",eo`
    ...
    `);import{html as Lt}from"../lit-all.min.js";var or=`
:root {
...
`;var Kt=class extends v{constructor(e){super(e)}getGlobalCSS(){return or}renderLayout(){return Lt`${this.cardImage}
    <div class="body">
...
`;var Wt=class extends v{constructor(e){super(e)}getGlobalCSS(){return nr}renderLayout(){return ar` ${this.badge}
    <div class="body">
        <div class="top-section">
            <slot name="icons"></slot>
            <slot name="heading-xs"></slot>
    ...
    ${this.card.customHr?"":ar`<hr />`} ${this.secureLabelFooter}`}};import{html as ht,css as ro,unsafeCSS as ge}from"../lit-all.min.js";var ir=`
  :root {
...
`;var oo=32,mt=class extends v{constructor(t){super(t);l(this,"getRowMinHeightPropertyName",t=>`--consonant-merch-card-footer-row-${t}-min-height`);l(this,"getMiniCompareFooter",()=>{let t=this.card.secureLabel?ht`<slot name="secure-transaction-label">
  ...
  `);import{html as _t,css as no,nothing as Qt}from"../lit-all.min.js";var cr=`
:root {
...
`;var Xt={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},addon:!0,secureLabel:!0,planType:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},sr={...function(){let{whatsIncluded:o,size:e,...t}=Xt;return t}(),title:{tag:"h3",slot:"heading-s"},secureLabel:!1},lr={...function(){let{subtitle:o,whatsIncluded:e,size:t,quantitySelect:r,...n}=Xt;return n}()},A=class extends v{constructor(e){super(e),this.adaptForMedia=this.adaptForMedia.bind(this)}priceOptionsProvider(e,t){e.dataset.template===Ze&&(t.displayPlanType=this.card?.settings?.displayPlanType??!1)}getGlobalCSS(){return cr}adjustSlotPlacement(e,t,r){let n=this.card.shadowRoot,a=n.querySelector("footer"),i=this.card.getAttribute("size"),s=n.querySelector(`footer slot[name="${e}"]`),d=n.querySelector(`.body slot[name="${e}"]`),p=n.querySelector(".body");if((!i||!i.includes("wide"))&&(a?.classList.remove("wide-footer"),s&&s.remove()),!!t.includes(i)){if(a?.classList.toggle("wide-footer",Bt()),!r&&s){if(d)s.remove();else{let g=p.querySelector(`[data-placeholder-for="${e}"]`);g?g.replaceWith(s):p.appendChild(s)}return}if(r&&d){let g=document.createElement("div");if(g.setAttribute("data-placeholder-for",e),g.classList.add("slot-placeholder"),!s){let x=d.cloneNode(!0);a.prepend(x)}d.replaceWith(g)}}}adaptForMedia(){if(!this.card.closest("merch-card-collection,overlay-trigger,.two-merch-cards,.three-merch-cards,.four-merch-cards, .columns")){this.card.removeAttribute("size");return}this.adjustSlotPlacement("addon",["super-wide"],Bt()),this.adjustSlotPlacement("callout-content",["super-wide"],Bt())}adjustCallout(){let e=this.card.querySelector('[slot="callout-content"] .icon-button');e&&e.title&&(e.dataset.tooltip=e.title,e.removeAttribute("title"),e.classList.add("hide-tooltip"),document.addEventListener("touchstart",t=>{t.preventDefault(),t.target!==e?e.classList.add("hide-tooltip"):t.target.classList.toggle("hide-tooltip")}),document.addEventListener("mouseover",t=>{t.preventDefault(),t.target!==e?e.classList.add("hide-tooltip"):t.target.classList.remove("hide-tooltip")}))}postCardUpdateHook(){this.adaptForMedia(),this.adjustTitleWidth(),this.adjustLegal(),this.adjustAddon(),this.adjustCallout()}get headingM(){return this.card.querySelector('[slot="heading-m"]')}get mainPrice(){return this.headingM.querySelector(`${f}[data-template="price"]`)}get divider(){return this.card.variant==="plans-education"?_t`<div class="divider"></div>`:Qt}async adjustLegal(){if(await this.card.updateComplete,await customElements.whenDefined("inline-price"),this.legalAdjusted)return;this.legalAdjusted=!0;let e=[],t=this.card.querySelector(`[slot="heading-m"] ${f}[data-template="price"]`);t&&e.push(t);let r=e.map(async n=>{let a=n.cloneNode(!0);await n.onceSettled(),n?.options&&(n.options.displayPerUnit&&(n.dataset.displayPerUnit="false"),n.options.displayTax&&(n.dataset.displayTax="false"),n.options.displayPlanType&&(n.dataset.displayPlanType="false"),a.setAttribute("data-template","legal"),n.parentNode.insertBefore(a,n.nextSibling))});await Promise.all(r)}async adjustAddon(){await this.card.updateComplete;let e=this.card.addon;if(!e)return;e.setAttribute("custom-checkbox","");let t=this.mainPrice;if(!t)return;await t.onceSettled();let r=t.value?.[0]?.planType;r&&(e.planType=r)}get stockCheckbox(){return this.card.checkboxLabel?_t`<label id="stock-checkbox">
    ...
    `),l(A,"collectionOptions",{customHeaderArea:e=>e.sidenav?_t`<slot name="resultsText"></slot>`:Qt,headerVisibility:{search:!1,sort:!1,result:["mobile","tablet"],custom:["desktop"]}});import{html as ue,css as ao}from"../lit-all.min.js";var dr=`
:root {
...
`;var pt=class extends v{constructor(e){super(e),this.postCardUpdateHook=this.postCardUpdateHook.bind(this)}getGlobalCSS(){return dr}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(t=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${t}"]`),t))}renderLayout(){return ue` ${this.badge}
...
`;var pr={name:{tag:"h4",slot:"detail-m"},title:{tag:"h4",slot:"detail-m"},backgroundImage:{tag:"div",slot:"bg-image"},prices:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"}},ut=class extends v{constructor(e){super(e)}getGlobalCSS(){return mr}get headingSelector(){return'[slot="detail-m"]'}renderLayout(){return xe`${this.cardImage}
            <div class="body">
    ...
    `);import{css as so,html as lo}from"../lit-all.min.js";var gr=`
...
`;var ur={title:{tag:"p",slot:"title"},prices:{tag:"p",slot:"prices"},description:{tag:"p",slot:"description"},planType:!0,ctas:{slot:"ctas",size:"S"}},ft=class extends v{constructor(){super(...arguments);l(this,"legal")}async postCardUpdateHook(){await this.card.updateComplete,this.adjustLegal()}getGlobalCSS(){return gr}get headingSelector(){return'[slot="title"]'}priceOptionsProvider(t,r){r.literals={...r.literals,strikethroughAriaLabel:"",alternativePriceAriaLabel:""},r.space=!0,r.displayAnnual=this.card.settings?.displayAnnual??!1}adjustLegal(){if(this.legal!==void 0)return;let t=this.card.querySelector(`${f}[data-template="price"]`);if(!t)return;let r=t.cloneNode(!0);this.legal=r,t.dataset.displayTax="false",r.dataset.template="legal",r.dataset.displayPlanType=this.card?.settings?.displayPlanType??!0,r.setAttribute("slot","legal"),this.card.appendChild(r)}renderLayout(){return lo`
            ${this.badge}
            <div class="body">
    ...
    `);var Jt=new Map,Zt=new WeakMap,C=(o,e,t=null,r=null,n)=>{Jt.set(o,{class:e,fragmentMapping:t,style:r,collectionOptions:n})};C("catalog",dt,rr,dt.variantStyle);C("image",Kt);C("inline-heading",Wt);C("mini-compare-chart",mt,null,mt.variantStyle);C("plans",A,Xt,A.variantStyle,A.collectionOptions);C("plans-students",A,lr,A.variantStyle,A.collectionOptions);C("plans-education",A,sr,A.variantStyle,A.collectionOptions);C("product",pt,null,pt.variantStyle);C("segment",gt,null,gt.variantStyle);C("special-offers",ut,pr,ut.variantStyle);C("mini",ft,ur,ft.variantStyle);var be=o=>{let e=Jt.get(o.variant);if(!e)return;let{class:t,style:r}=e,n=Zt.get(o);if(n?.appliedVariant===o.variant)return new t(o);if(r)try{let a=new CSSStyleSheet;if(a.replaceSync(r.cssText),n?.styleSheet){let i=o.shadowRoot.adoptedStyleSheets.indexOf(n.styleSheet);i!==-1&&o.shadowRoot.adoptedStyleSheets.splice(i,1)}o.shadowRoot.adoptedStyleSheets.push(a),Zt.set(o,{appliedVariant:o.variant,styleSheet:a})}catch{let i=document.createElement("style");if(i.textContent=r.cssText,i.setAttribute("data-variant-style",o.variant),n?.styleElement)n.styleElement.remove();else{let s=o.shadowRoot.querySelector("[data-variant-style]");s&&s.remove()}o.shadowRoot.appendChild(i),Zt.set(o,{appliedVariant:o.variant,styleElement:i})}else Zt.set(o,{appliedVariant:o.variant});return new t(o)};function Yt(o){return Jt.get(o)?.fragmentMapping}function fr(o){return Jt.get(o)?.collectionOptions}var xr=document.createElement("style");xr.innerHTML=`
:root {
...
Caused by: ${this.cause}`),t}};var po="mas-commerce-service",go={requestId:Ht,etag:"Etag",lastModified:"Last-Modified",serverTiming:"server-timing"};var re=o=>window.setTimeout(o);function ye(){return document.getElementsByTagName(po)?.[0]}function vr(o){let e={};if(!o?.headers)return e;let t=o.headers;for(let[r,n]of Object.entries(go)){let a=t.get(n);a&&(a=a.replace(/[,;]/g,"|"),a=a.replace(/[| ]+/g,"|"),e[r]=a)}return e}async function yr(o,e={},t=2,r=100){let n;for(let a=0;a<=t;a++)try{let i=await fetch(o,e);return i.retryCount=a,i}catch(i){if(n=i,n.retryCount=a,a>t)break;await new Promise(s=>setTimeout(s,r*(a+1)))}throw n}var Er="fragment",wr="author",Sr="preview",Ar="loading",Tr="timeout",Ee="aem-fragment",kr="eager",Cr="cache",uo=[kr,Cr],$,Q,R,we=class{constructor(){m(this,$,new Map);m(this,Q,new Map);m(this,R,new Map)}clear(){c(this,$).clear(),c(this,Q).clear(),c(this,R).clear()}add(e){if(!this.has(e.id)&&!this.has(e.fields?.originalId)){if(c(this,$).set(e.id,e),e.fields?.originalId&&c(this,$).set(e.fields.originalId,e),c(this,R).has(e.id)){let[,t]=c(this,R).get(e.id);t()}if(c(this,R).has(e.fields?.originalId)){let[,t]=c(this,R).get(e.fields?.originalId);t()}if(e.references)for(let t in e.references){let{type:r,value:n}=e.references[t];r==="content-fragment"&&(n.settings={...e?.settings,...n.settings},n.placeholders={...e?.placeholders,...n.placeholders},n.dictionary={...e?.dictionary,...n.dictionary},n.priceLiterals={...e?.priceLiterals,...n.priceLiterals},this.add(n,e))}}}has(e){return c(this,$).has(e)}entries(){return c(this,$).entries()}get(e){return c(this,$).get(e)}getAsPromise(e){let[t]=c(this,R).get(e)??[];if(t)return t;let r;return t=new Promise(n=>{r=n,this.has(e)&&n()}),c(this,R).set(e,[t,r]),t}getFetchInfo(e){let t=c(this,Q).get(e);return t||(t={url:null,retryCount:0,stale:!1,measure:null,status:null},c(this,Q).set(e,t)),t}remove(e){c(this,$).delete(e),c(this,Q).delete(e),c(this,R).delete(e)}};$=new WeakMap,Q=new WeakMap,R=new WeakMap;var q=new we,xt,z,D,L,T,y,Rt,Pt,P,Mt,Nt,bt,M,Lr,_r,Se,Rr,oe=class extends HTMLElement{constructor(){super(...arguments);m(this,M);l(this,"cache",q);m(this,xt);m(this,z,null);m(this,D,null);m(this,L,null);m(this,T);m(this,y);m(this,Rt,kr);m(this,Pt,5e3);m(this,P);m(this,Mt,!1);m(this,Nt,0);m(this,bt)}static get observedAttributes(){return[Er,Ar,Tr,wr,Sr]}attributeChangedCallback(t,r,n){t===Er&&(h(this,T,n),h(this,y,q.getFetchInfo(n))),t===Ar&&uo.includes(n)&&h(this,Rt,n),t===Tr&&h(this,Pt,parseInt(n,10)),t===wr&&h(this,Mt,["","true"].includes(n)),t===Sr&&h(this,bt,n)}connectedCallback(){if(!c(this,P)){if(c(this,L)??h(this,L,Y(this)),h(this,bt,c(this,L).settings?.preview),c(this,xt)??h(this,xt,c(this,L).log.module(`${Ee}[${c(this,T)}]`)),!c(this,T)||c(this,T)==="#"){c(this,y)??h(this,y,q.getFetchInfo("missing-fragment-id")),w(this,M,Se).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(c(this,y)).filter(([t,r])=>r!=null).map(([t,r])=>[`aem-fragment:${t}`,r]))}async refresh(t=!0){if(c(this,P)&&!await Promise.race([c(this,P),Promise.resolve(!1)]))return;t&&q.remove(c(this,T)),c(this,Rt)===Cr&&await Promise.race([q.getAsPromise(c(this,T)),new Promise(s=>setTimeout(s,c(this,Pt)))]);try{h(this,P,w(this,M,Rr).call(this)),await c(this,P)}catch(s){return w(this,M,Se).call(this,s.message),!1}let{references:r,referencesTree:n,placeholders:a,wcs:i}=c(this,z)||{};return i&&!te("mas.disableWcsCache")&&c(this,L).prefillWcsCache(i),this.dispatchEvent(new CustomEvent(nt,{detail:{...this.data,references:r,referencesTree:n,placeholders:a,...c(this,y)},bubbles:!0,composed:!0})),c(this,P)}get updateComplete(){return c(this,P)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return c(this,D)?c(this,D):(c(this,Mt)?this.transformAuthorData():this.transformPublishData(),c(this,D))}transformAuthorData(){let{fields:t,id:r,tags:n,settings:a={},priceLiterals:i={},dictionary:s={},placeholders:d={}}=c(this,z);h(this,D,t.reduce((p,{name:g,multiple:x,values:_})=>(p.fields[g]=x?_:_[0],p),{fields:{},id:r,tags:n,settings:a,priceLiterals:i,dictionary:s,placeholders:d}))}transformPublishData(){let{fields:t,id:r,tags:n,settings:a={},priceLiterals:i={},dictionary:s={},placeholders:d={}}=c(this,z);h(this,D,Object.entries(t).reduce((p,[g,x])=>(p.fields[g]=x?.mimeType?x.value:x??"",p),{fields:{},id:r,tags:n,settings:a,priceLiterals:i,dictionary:s,placeholders:d}))}getFragmentClientUrl(){let r=new URLSearchParams(window.location.search).get("maslibs");if(!r||r.trim()==="")return"https://mas.adobe.com/studio/libs/fragment-client.js";let n=r.trim().toLowerCase();if(n==="local")return"http://localhost:3030/studio/libs/fragment-client.js";let{hostname:a}=window.location,i=a.endsWith(".page")?"page":"live";return n.includes("--")?`https://${n}.aem.${i}/studio/libs/fragment-client.js`:`https://${n}--mas--adobecom.aem.${i}/studio/libs/fragment-client.js`}async generatePreview(){let t=this.getFragmentClientUrl(),{previewFragment:r}=await import(t);return await r(c(this,T),{locale:c(this,L).settings.locale,apiKey:c(this,L).settings.wcsApiKey})}};xt=new WeakMap,z=new WeakMap,D=new WeakMap,L=new WeakMap,T=new WeakMap,y=new WeakMap,Rt=new WeakMap,Pt=new WeakMap,P=new WeakMap,Mt=new WeakMap,Nt=new WeakMap,bt=new WeakMap,M=new WeakSet,Lr=async function(t){$e(this,Nt)._++;let r=`${Ee}:${c(this,T)}:${c(this,Nt)}`,n=`${r}${qt}`,a=`${r}${jt}`;if(c(this,bt))return await this.generatePreview();performance.mark(n);let i;try{if(c(this,y).stale=!1,c(this,y).url=t,i=await yr(t,{cache:"default",credentials:"omit"}),w(this,M,_r).call(this,i),c(this,y).status=i?.status,c(this,y).measure=it(performance.measure(a,n)),c(this,y).retryCount=i.retryCount,!i?.ok)throw new W("Unexpected fragment response",{response:i,...c(this,L).duration});return await i.json()}catch(s){if(c(this,y).measure=it(performance.measure(a,n)),c(this,y).retryCount=s.retryCount,c(this,z))return c(this,y).stale=!0,c(this,xt).error("Serving stale data",c(this,y)),c(this,z);let d=s.message??"unknown";throw new W(`Failed to fetch fragment: ${d}`,{})}},_r=function(t){Object.assign(c(this,y),vr(t))},Se=function(t){h(this,P,null),c(this,y).message=t,this.classList.add("error");let r={...c(this,y),...c(this,L).duration};c(this,xt).error(t,r),this.dispatchEvent(new CustomEvent(at,{detail:r,bubbles:!0,composed:!0}))},Rr=async function(){var s;this.classList.remove("error"),h(this,D,null);let t=q.get(c(this,T));if(t)return h(this,z,t),!0;let{masIOUrl:r,wcsApiKey:n,locale:a}=c(this,L).settings,i=`${r}/fragment?id=${c(this,T)}&api_key=${n}&locale=${a}`;return t=await w(this,M,Lr).call(this,i),(s=t.fields).originalId??(s.originalId=c(this,T)),q.add(t),h(this,z,t),!0},l(oe,"cache",q);customElements.define(Ee,oe);import{LitElement as fo,html as xo,css as bo}from"../lit-all.min.js";var vt=class extends fo{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent}connectedCallback(){this.borderColor&&this.borderColor!=="Transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-border-radius","4px 0 0 4px"),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.textContent="",super.connectedCallback()}render(){return xo`<div class="badge">
    ...
    `);customElements.define("merch-badge",vt);import{html as vo,css as yo,LitElement as Eo}from"../lit-all.min.js";var Ot=class extends Eo{constructor(){super()}render(){return vo`
            <slot name="icon"></slot>
    ...
    `),l(Ot,"properties",{description:{type:String,attribute:!0}});customElements.define("merch-mnemonic-list",Ot);import{html as Ae,css as wo,LitElement as So}from"../lit-all.min.js";var $t=class extends So{updated(){this.hideSeeMoreEls()}hideSeeMoreEls(){this.isMobile&&this.rows.forEach((e,t)=>{t>=5&&(e.style.display=this.showAll?"flex":"none")})}constructor(){super(),this.showAll=!1,this.mobileRows=this.mobileRows===void 0?5:this.mobileRows}toggle(){this.showAll=!this.showAll,this.dispatchEvent(new CustomEvent("hide-see-more-elements",{bubbles:!0,composed:!0})),this.requestUpdate()}render(){return Ae`<slot name="heading"></slot>
            <slot name="content"></slot>
            ${this.isMobile&&this.rows.length>this.mobileRows?Ae`<div @click=${this.toggle} class="see-more">
                      ${this.showAll?"- See less":"+ See more"}
                  </div>`:Ae``}`}get isMobile(){return window.matchMedia("(max-width: 767px)").matches}get rows(){return this.querySelectorAll("merch-mnemonic-list")}};l($t,"styles",wo`
        :host {
            display: flex;
            flex-wrap: wrap;
            align-items: center;
    ...
    `),l($t,"properties",{heading:{type:String,attribute:!0},mobileRows:{type:Number,attribute:!0}});customElements.define("merch-whats-included",$t);var X={clientId:"merch-at-scale",delimiter:"\xB6",ignoredProperties:["analytics","literals","element"],serializableTypes:["Array","Object"],sampleRate:1,tags:"acom",isProdDomain:!1},Pr=1e3;function Ao(o){return o instanceof Error||typeof o?.originatingRequest=="string"}function Mr(o){if(o==null)return;let e=typeof o;if(e==="function")return o.name?`function ${o.name}`:"function";if(e==="object"){if(o instanceof Error)return o.message;if(typeof o.originatingRequest=="string"){let{message:r,originatingRequest:n,status:a}=o;return[r,a,n].filter(Boolean).join(" ")}let t=o[Symbol.toStringTag]??Object.getPrototypeOf(o).constructor.name;if(!X.serializableTypes.includes(t))return t}return o}function To(o,e){if(!X.ignoredProperties.includes(o))return Mr(e)}var Te={append(o){if(o.level!=="error")return;let{message:e,params:t}=o,r=[],n=[],a=e;t.forEach(p=>{p!=null&&(Ao(p)?r:n).push(p)}),r.length&&(a+=" "+r.map(Mr).join(" "));let{pathname:i,search:s}=window.location,d=`${X.delimiter}page=${i}${s}`;d.length>Pr&&(d=`${d.slice(0,Pr)}<trunc>`),a+=d,n.length&&(a+=`${X.delimiter}facts=`,a+=JSON.stringify(n,To)),window.lana?.log(a,X)}};function Nr(o){Object.assign(X,Object.fromEntries(Object.entries(o).filter(([e,t])=>e in X&&t!==""&&t!==null&&t!==void 0&&!Number.isNaN(t))))}var Or={LOCAL:"local",PROD:"prod",STAGE:"stage"},ke={DEBUG:"debug",ERROR:"error",INFO:"info",WARN:"warn"},Ce=new Set,Le=new Set,$r=new Map,zr={append({level:o,message:e,params:t,timestamp:r,source:n}){console[o](`${r}ms [${n}] %c${e}`,"font-weight: bold;",...t)}},Ir={filter:({level:o})=>o!==ke.DEBUG},ko={filter:()=>!1};function Co(o,e,t,r,n){return{level:o,message:e,namespace:t,get params(){return r.length===1&&ee(r[0])&&(r=r[0](),Array.isArray(r)||(r=[r])),r},source:n,timestamp:performance.now().toFixed(3)}}function Lo(o){[...Le].every(e=>e(o))&&Ce.forEach(e=>e(o))}function Dr(o){let e=($r.get(o)??0)+1;$r.set(o,e);let t=`${o} #${e}`,r={id:t,namespace:o,module:n=>Dr(`${r.namespace}/${n}`),updateConfig:Nr};return Object.values(ke).forEach(n=>{r[n]=(a,...i)=>Lo(Co(n,a,o,i,t))}),Object.seal(r)}function ne(...o){o.forEach(e=>{let{append:t,filter:r}=e;ee(r)&&Le.add(r),ee(t)&&Ce.add(t)})}function _o(o={}){let{name:e}=o,t=br(te("commerce.debug",{search:!0,storage:!0}),e===Or.LOCAL);return ne(t?zr:Ir),e===Or.PROD&&ne(Te),_e}function Ro(){Ce.clear(),Le.clear()}var _e={...Dr(Xe),Level:ke,Plugins:{consoleAppender:zr,debugFilter:Ir,quietFilter:ko,lanaAppender:Te},init:_o,reset:Ro,use:ne};var Po={[B]:Ye,[V]:Ke,[H]:We},Mo={[B]:Qe,[H]:St},zt,ae=class{constructor(e){m(this,zt);l(this,"changes",new Map);l(this,"connected",!1);l(this,"error");l(this,"log");l(this,"options");l(this,"promises",[]);l(this,"state",V);l(this,"timer",null);l(this,"value");l(this,"version",0);l(this,"wrapperElement");this.wrapperElement=e,this.log=_e.module("mas-element")}update(){[B,V,H].forEach(e=>{this.wrapperElement.classList.toggle(Po[e],e===this.state)})}notify(){(this.state===H||this.state===B)&&(this.state===H?this.promises.forEach(({resolve:t})=>t(this.wrapperElement)):this.state===B&&this.promises.forEach(({reject:t})=>t(this.error)),this.promises=[]);let e=this.error;this.error instanceof W&&(e={message:this.error.message,...this.error.context}),this.wrapperElement.dispatchEvent(new CustomEvent(Mo[this.state],{bubbles:!0,detail:e}))}attributeChangedCallback(e,t,r){this.changes.set(e,r),this.requestUpdate()}connectedCallback(){h(this,zt,ye()),this.requestUpdate(!0)}disconnectedCallback(){this.connected&&(this.connected=!1,this.log?.debug("Disconnected:",{element:this.wrapperElement}))}onceSettled(){let{error:e,promises:t,state:r}=this;return H===r?Promise.resolve(this.wrapperElement):B===r?Promise.reject(e):new Promise((n,a)=>{t.push({resolve:n,reject:a})})}toggleResolved(e,t,r){return e!==this.version?!1:(r!==void 0&&(this.options=r),this.state=H,this.value=t,this.update(),this.log?.debug("Resolved:",{element:this.wrapperElement,value:t}),re(()=>this.notify()),!0)}toggleFailed(e,t,r){if(e!==this.version)return!1;r!==void 0&&(this.options=r),this.error=t,this.state=B,this.update();let n=this.wrapperElement.getAttribute("is");return this.log?.error(`${n}: Failed to render: ${t.message}`,{element:this.wrapperElement,...t.context,...c(this,zt)?.duration}),re(()=>this.notify()),!0}togglePending(e){return this.version++,e&&(this.options=e),this.state=V,this.update(),this.log?.debug("Pending:",{osi:this.wrapperElement?.options?.wcsOsi}),this.version}requestUpdate(e=!1){if(!this.wrapperElement.isConnected||!ye()||this.timer)return;let{error:t,options:r,state:n,value:a,version:i}=this;this.state=V,this.timer=re(async()=>{this.timer=null;let s=null;if(this.changes.size&&(s=Object.fromEntries(this.changes.entries()),this.changes.clear()),this.connected?this.log?.debug("Updated:",{element:this.wrapperElement,changes:s}):(this.connected=!0,this.log?.debug("Connected:",{element:this.wrapperElement,changes:s})),s||e)try{await this.wrapperElement.render?.()===!1&&this.state===V&&this.version===i&&(this.state=n,this.error=t,this.value=a,this.update(),this.notify())}catch(d){this.toggleFailed(this.version,d,r)}})}};zt=new WeakMap;function No(o){return`https://${o==="PRODUCTION"?"www.adobe.com":"www.stage.adobe.com"}/offers/promo-terms.html`}var J,Z=class Z extends HTMLAnchorElement{constructor(){super();l(this,"masElement",new ae(this));m(this,J);this.setAttribute("is",Z.is)}get isUptLink(){return!0}initializeWcsData(t,r){this.setAttribute("data-wcs-osi",t),r&&this.setAttribute("data-promotion-code",r)}attributeChangedCallback(t,r,n){this.masElement.attributeChangedCallback(t,r,n)}connectedCallback(){this.masElement.connectedCallback(),h(this,J,Y()),c(this,J)&&(this.log=c(this,J).log.module("upt-link"))}disconnectedCallback(){this.masElement.disconnectedCallback(),h(this,J,void 0)}requestUpdate(t=!1){this.masElement.requestUpdate(t)}onceSettled(){return this.masElement.onceSettled()}async render(){let t=Y();if(!t)return!1;this.dataset.imsCountry||t.imsCountryPromise.then(i=>{i&&(this.dataset.imsCountry=i)});let r=t.collectCheckoutOptions({},this);if(!r.wcsOsi)return this.log.error("Missing 'data-wcs-osi' attribute on upt-link."),!1;let n=this.masElement.togglePending(r),a=t.resolveOfferSelectors(r);try{let[[i]]=await Promise.all(a),{country:s,language:d,env:p}=r,g=`locale=${d}_${s}&country=${s}&offer_id=${i.offerId}`,x=this.getAttribute("data-promotion-code");x&&(g+=`&promotion_code=${encodeURIComponent(x)}`),this.href=`${No(p)}?${g}`,this.masElement.toggleResolved(n,i,r)}catch(i){let s=new Error(`Could not resolve offer selectors for id: ${r.wcsOsi}.`,i.message);return this.masElement.toggleFailed(n,s,r),!1}}static createFrom(t){let r=new Z;for(let n of t.attributes)n.name!=="is"&&(n.name==="class"&&n.value.includes("upt-link")?r.setAttribute("class",n.value.replace("upt-link","").trim()):r.setAttribute(n.name,n.value));return r.innerHTML=t.innerHTML,r.setAttribute("tabindex",0),r}};J=new WeakMap,l(Z,"is","upt-link"),l(Z,"tag","a"),l(Z,"observedAttributes",["data-wcs-osi","data-promotion-code","data-ims-country"]);var j=Z;window.customElements.get(j.is)||window.customElements.define(j.is,j,{extends:j.tag});var Oo="#000000",Re="#F8D904",$o="#EAEAEA",zo="#31A547",Io=/(accent|primary|secondary)(-(outline|link))?/,Do="mas:product_code/",Fo="daa-ll",ie="daa-lh",Uo=["XL","L","M","S"],Pe="...";function N(o,e,t,r){let n=r[o];if(e[o]&&n){let a={slot:n?.slot},i=e[o];if(n.maxCount&&typeof i=="string"){let[d,p]=on(i,n.maxCount,n.withSuffix);d!==i&&(a.title=p,i=d)}let s=S(n.tag,a,i);t.append(s)}}function Bo(o,e,t){let r=o.mnemonicIcon?.map((a,i)=>({icon:a,alt:o.mnemonicAlt[i]??"",link:o.mnemonicLink[i]??""}));r?.forEach(({icon:a,alt:i,link:s})=>{if(s&&!/^https?:/.test(s))try{s=new URL(`https://${s}`).href.toString()}catch{s="#"}let d={slot:"icons",src:a,loading:e.loading,size:t?.size??"l"};i&&(d.alt=i),s&&(d.href=s);let p=S("merch-icon",d);e.append(p)});let n=e.shadowRoot.querySelector('slot[name="icons"]');!r?.length&&n&&n.remove()}function Ho(o,e,t){if(t.badge?.slot){if(o.badge?.length&&!o.badge?.startsWith("<merch-badge")){let r=Re,n=!1;t.allowedBadgeColors?.includes(t.badge?.default)&&(r=t.badge?.default,o.borderColor||(n=!0));let a=o.badgeBackgroundColor||r,i=o.borderColor||"";n&&(i=t.badge?.default,o.borderColor=t.badge?.default),o.badge=`<merch-badge variant="${o.variant}" background-color="${a}" border-color="${i}">${o.badge}</merch-badge>`}N("badge",o,e,t)}else o.badge?(e.setAttribute("badge-text",o.badge),e.setAttribute("badge-color",o.badgeColor||Oo),e.setAttribute("badge-background-color",o.badgeBackgroundColor||Re),e.setAttribute("border-color",o.badgeBackgroundColor||Re)):e.setAttribute("border-color",o.borderColor||$o)}function qo(o,e,t){if(t.trialBadge&&o.trialBadge){if(!o.trialBadge.startsWith("<merch-badge")){let r=o.trialBadgeBorderColor||zo;o.trialBadge=`<merch-badge variant="${o.variant}" border-color="${r}">${o.trialBadge}</merch-badge>`}N("trialBadge",o,e,t)}}function jo(o,e,t){t?.includes(o.size)&&e.setAttribute("size",o.size)}function Go(o,e){o.cardName&&e.setAttribute("name",o.cardName)}function Vo(o,e,t){N("cardTitle",o,e,{cardTitle:t})}function Yo(o,e,t){N("subtitle",o,e,t)}function Ko(o,e,t,r){if(!o.backgroundColor||o.backgroundColor.toLowerCase()==="default"){e.style.removeProperty("--merch-card-custom-background-color"),e.removeAttribute("background-color");return}t?.[o.backgroundColor]?(e.style.setProperty("--merch-card-custom-background-color",`var(${t[o.backgroundColor]})`),e.setAttribute("background-color",o.backgroundColor)):r?.attribute&&o.backgroundColor&&(e.setAttribute(r.attribute,o.backgroundColor),e.style.removeProperty("--merch-card-custom-background-color"))}function Wo(o,e,t){let r=t?.borderColor,n="--merch-card-custom-border-color";o.borderColor?.toLowerCase()==="transparent"?(e.style.removeProperty(n),t?.allowedBorderColors?.includes(t?.badge?.default)&&e.style.setProperty(n,"transparent")):o.borderColor&&r&&(/-gradient/.test(o.borderColor)?(e.setAttribute("gradient-border","true"),e.style.removeProperty(n)):e.style.setProperty(n,`var(--${o.borderColor})`))}function Qo(o,e,t){if(o.backgroundImage){let r={loading:e.loading??"lazy",src:o.backgroundImage};if(o.backgroundImageAltText?r.alt=o.backgroundImageAltText:r.role="none",!t)return;if(t?.attribute){e.setAttribute(t.attribute,o.backgroundImage);return}e.append(S(t.tag,{slot:t.slot},S("img",r)))}}function Xo(o,e,t){N("prices",o,e,t)}function Ur(o,e,t){let r=o.hasAttribute("data-wcs-osi")&&!!o.getAttribute("data-wcs-osi"),n=o.className||"",a=Io.exec(n)?.[0]??"accent",i=a.includes("accent"),s=a.includes("primary"),d=a.includes("secondary"),p=a.includes("-outline"),g=a.includes("-link");o.classList.remove("accent","primary","secondary");let x;if(e.consonant)x=sn(o,i,r,g);else if(g)x=o;else{let _;i?_="accent":s?_="primary":d&&(_="secondary"),x=e.spectrum==="swc"?cn(o,t,p,_,r):an(o,t,p,_,r)}return x}function Zo(o,e){let{slot:t}=e?.description,r=o.querySelectorAll(`[slot="${t}"] a[data-wcs-osi]`);r.length&&r.forEach(n=>{let a=Ur(n,o,e);n.replaceWith(a)})}function Jo(o,e,t){N("promoText",o,e,t),N("description",o,e,t),Zo(e,t),N("callout",o,e,t),N("quantitySelect",o,e,t),N("whatsIncluded",o,e,t)}function tn(o,e,t){if(!t.addon)return;let r=o.addon?.replace(/[{}]/g,"");if(!r||/disabled/.test(r))return;let n=S("merch-addon",{slot:"addon"},r);[...n.querySelectorAll(f)].forEach(a=>{let i=a.parentElement;i?.nodeName==="P"&&i.setAttribute("data-plan-type","")}),e.append(n)}function en(o,e,t){o.addonConfirmation&&N("addonConfirmation",o,e,t)}function rn(o,e,t,r){r?.secureLabel&&t?.secureLabel&&e.setAttribute("secure-label",r.secureLabel)}function on(o,e,t=!0){try{let r=typeof o!="string"?"":o,n=Fr(r);if(n.length<=e)return[r,n];let a=0,i=!1,s=t?e-Pe.length<1?1:e-Pe.length:e,d=[];for(let x of r){if(a++,x==="<")if(i=!0,r[a]==="/")d.pop();else{let _="";for(let le of r.substring(a)){if(le===" "||le===">")break;_+=le}d.push(_)}if(x==="/"&&r[a]===">"&&d.pop(),x===">"){i=!1;continue}if(!i&&(s--,s===0))break}let p=r.substring(0,a).trim();if(d.length>0){d[0]==="p"&&d.shift();for(let x of d.reverse())p+=`</${x}>`}return[`${p}${t?Pe:""}`,n]}catch{let n=typeof o=="string"?o:"",a=Fr(n);return[n,a]}}function Fr(o){if(!o)return"";let e="",t=!1;for(let r of o){if(r==="<"&&(t=!0),r===">"){t=!1;continue}t||(e+=r)}return e}function nn(o,e){e.querySelectorAll("a.upt-link").forEach(r=>{let n=j.createFrom(r);r.replaceWith(n),n.initializeWcsData(o.osi,o.promoCode)})}function an(o,e,t,r,n){let a=o;n?a=customElements.get("checkout-button").createCheckoutButton({},o.innerHTML):a.innerHTML=`<span>${a.textContent}</span>`,a.setAttribute("tabindex",0);for(let g of o.attributes)["class","is"].includes(g.name)||a.setAttribute(g.name,g.value);a.firstElementChild?.classList.add("spectrum-Button-label");let i=e?.ctas?.size??"M",s=`spectrum-Button--${r}`,d=Uo.includes(i)?`spectrum-Button--size${i}`:"spectrum-Button--sizeM",p=["spectrum-Button",s,d];return t&&p.push("spectrum-Button--outline"),a.classList.add(...p),a}function cn(o,e,t,r,n){let a=o;n&&(a=customElements.get("checkout-button").createCheckoutButton(o.dataset),a.connectedCallback(),a.render());let i="fill";t&&(i="outline");let s=S("sp-button",{treatment:i,variant:r,tabIndex:0,size:e?.ctas?.size??"m",...o.dataset.analyticsId&&{"data-analytics-id":o.dataset.analyticsId}},o.innerHTML);return s.source=a,(n?a.onceSettled():Promise.resolve(a)).then(d=>{s.setAttribute("data-navigation-url",d.href)}),s.addEventListener("click",d=>{d.defaultPrevented||a.click()}),s}function sn(o,e,t,r){let n=o;return t&&(n=customElements.get("checkout-link").createCheckoutLink(o.dataset,o.innerHTML)),r||(n.classList.add("con-button"),e&&n.classList.add("blue")),n}function ln(o,e,t,r){if(o.ctas){let{slot:n}=t.ctas,a=S("div",{slot:n},o.ctas),i=[...a.querySelectorAll("a")].map(s=>Ur(s,e,t));a.innerHTML="",a.append(...i),e.append(a)}}function dn(o,e){let{tags:t}=o,r=t?.find(a=>a.startsWith(Do))?.split("/").pop();if(!r)return;e.setAttribute(ie,r),[...e.shadowRoot.querySelectorAll("a[data-analytics-id],button[data-analytics-id]"),...e.querySelectorAll("a[data-analytics-id],button[data-analytics-id]")].forEach((a,i)=>{a.setAttribute(Fo,`${a.dataset.analyticsId}-${i+1}`)})}function hn(o){o.spectrum==="css"&&[["primary-link","primary"],["secondary-link","secondary"]].forEach(([e,t])=>{o.querySelectorAll(`a.${e}`).forEach(r=>{r.classList.remove(e),r.classList.add("spectrum-Link",`spectrum-Link--${t}`)})})}function mn(o){o.querySelectorAll("[slot]").forEach(r=>{r.remove()}),o.variant=void 0,["checkbox-label","stock-offer-osis","secure-label","background-image","background-color","border-color","badge-background-color","badge-color","badge-text","gradient-border","size",ie].forEach(r=>o.removeAttribute(r));let t=["wide-strip","thin-strip"];o.classList.remove(...t)}async function Br(o,e){if(!o){let d=e?.id||"unknown";throw console.error(`hydrate: Fragment is undefined. Cannot hydrate card (merchCard id: ${d}).`),new Error(`hydrate: Fragment is undefined for card (merchCard id: ${d}).`)}if(!o.fields){let d=o.id||"unknown",p=e?.id||"unknown";throw console.error(`hydrate: Fragment for card ID '${d}' (merchCard id: ${p}) is missing 'fields'. Cannot hydrate.`),new Error(`hydrate: Fragment for card ID '${d}' (merchCard id: ${p}) is missing 'fields'.`)}let{id:t,fields:r,settings:n={},priceLiterals:a}=o,{variant:i}=r;if(!i)throw new Error(`hydrate: no variant found in payload ${t}`);mn(e),e.settings=n,a&&(e.priceLiterals=a),e.id??(e.id=o.id),e.variant=i,await e.updateComplete;let{aemFragmentMapping:s}=e.variantLayout;if(!s)throw new Error(`hydrate: variant mapping not found for ${t}`);s.style==="consonant"&&e.setAttribute("consonant",!0),Bo(r,e,s.mnemonics),Ho(r,e,s),qo(r,e,s),jo(r,e,s.size),Go(r,e),Vo(r,e,s.title),Yo(r,e,s),Xo(r,e,s),Qo(r,e,s.backgroundImage),Ko(r,e,s.allowedColors,s.backgroundColor),Wo(r,e,s),Jo(r,e,s),tn(r,e,s),en(r,e,s),rn(r,e,s,n),nn(r,e),ln(r,e,s,i),dn(r,e),hn(e)}var Ne="merch-card",Me=2e4,Hr="merch-card:";function qr(o,e){let t=o.closest(Ne);if(!t)return e;t.priceLiterals&&(e.literals??(e.literals={}),Object.assign(e.literals,t.priceLiterals)),t.variantLayout?.priceOptionsProvider?.(o,e)}function gn(o){o.providers.has(qr)||o.providers.price(qr)}var un=0,yt,Et,wt,F,et,I,rt,E,tt,ce,jr,se,G=class extends pn{constructor(){super();m(this,E);m(this,yt);m(this,Et);m(this,wt);m(this,F);m(this,et);m(this,I);m(this,rt,new Promise(t=>{h(this,I,t)}));l(this,"customerSegment");l(this,"marketSegment");l(this,"variantLayout");this.id=null,this.failed=!1,this.filters={},this.types="",this.selected=!1,this.spectrum="css",this.loading="lazy",this.handleAemFragmentEvents=this.handleAemFragmentEvents.bind(this),this.handleMerchOfferSelectReady=this.handleMerchOfferSelectReady.bind(this)}firstUpdated(){this.variantLayout=be(this),this.variantLayout?.connectedCallbackHook()}willUpdate(t){(t.has("variant")||!this.variantLayout)&&(this.variantLayout=be(this),this.variantLayout?.connectedCallbackHook())}updated(t){(t.has("badgeBackgroundColor")||t.has("borderColor"))&&this.style.setProperty("--consonant-merch-card-border",this.computedBorderStyle),t.has("backgroundColor")&&this.style.setProperty("--merch-card-custom-background-color",this.backgroundColor?`var(--${this.backgroundColor})`:"");try{this.variantLayoutPromise=this.variantLayout?.postCardUpdateHook(t)}catch(r){w(this,E,tt).call(this,`Error in postCardUpdateHook: ${r.message}`,{},!1)}}get theme(){return this.closest("sp-theme")}get dir(){return this.closest("[dir]")?.getAttribute("dir")??"ltr"}render(){if(!(!this.isConnected||!this.variantLayout||this.style.display==="none"))return this.variantLayout.renderLayout()}get computedBorderStyle(){return["ccd-slice","ccd-suggested","ah-promoted-plans"].includes(this.variant)?"":`1px solid ${this.borderColor?this.borderColor:this.badgeBackgroundColor}`}get badgeElement(){return this.shadowRoot.getElementById("badge")}get headingmMSlot(){return this.shadowRoot.querySelector('slot[name="heading-m"]').assignedElements()[0]}get footerSlot(){return this.shadowRoot.querySelector('slot[name="footer"]')?.assignedElements()[0]}get descriptionSlot(){return this.shadowRoot.querySelector('slot[name="body-xs"')?.assignedElements()[0]}get descriptionSlotCompare(){return this.shadowRoot.querySelector('slot[name="body-m"')?.assignedElements()[0]}get price(){return this.headingmMSlot?.querySelector(f)}get checkoutLinks(){return[...this.footerSlot?.querySelectorAll(U)??[]]}get checkoutLinksDescription(){return[...this.descriptionSlot?.querySelectorAll(U)??[]]}get checkoutLinkDescriptionCompare(){return[...this.descriptionSlotCompare?.querySelectorAll(U)??[]]}get activeDescriptionLinks(){return this.variant==="mini-compare-chart"?this.checkoutLinkDescriptionCompare:this.checkoutLinksDescription}async toggleStockOffer({target:t}){if(!this.stockOfferOsis)return;let r=this.checkoutLinks;if(r.length!==0)for(let n of r){await n.onceSettled();let a=n.value?.[0]?.planType;if(!a)return;let i=this.stockOfferOsis[a];if(!i)return;let s=n.dataset.wcsOsi.split(",").filter(d=>d!==i);t.checked&&s.push(i),n.dataset.wcsOsi=s.join(",")}}changeHandler(t){t.target.tagName==="MERCH-ADDON"&&this.toggleAddon(t.target)}toggleAddon(t){this.variantLayout?.toggleAddon?.(t);let r=[...this.checkoutLinks,...this.activeDescriptionLinks??[]];if(r.length===0)return;let n=a=>{let{offerType:i,planType:s}=a.value?.[0]??{};if(!i||!s)return;let d=t.getOsi(s,i),p=(a.dataset.wcsOsi||"").split(",").filter(g=>g&&g!==d);t.checked&&p.push(d),a.dataset.wcsOsi=p.join(",")};r.forEach(n)}handleQuantitySelection(t){let r=[...this.checkoutLinks,...this.activeDescriptionLinks??[]];if(r.length!==0)for(let n of r)n.dataset.quantity=t.detail.option}get titleElement(){return this.querySelector(this.variantLayout?.headingSelector||".card-heading")}get title(){return this.titleElement?.textContent?.trim()}get description(){return this.querySelector('[slot="body-xs"]')?.textContent?.trim()}updateFilters(t){let r={...this.filters};Object.keys(r).forEach(n=>{if(t){r[n].order=Math.min(r[n].order||2,2);return}let a=r[n].order;a===1||isNaN(a)||(r[n].order=Number(a)+1)}),this.filters=r}includes(t){return this.textContent.match(new RegExp(t,"i"))!==null}connectedCallback(){var r;super.connectedCallback(),c(this,Et)||h(this,Et,un++),this.aemFragment||((r=c(this,I))==null||r.call(this),h(this,I,void 0)),this.id??(this.id=this.getAttribute("id")??this.aemFragment?.getAttribute("fragment"));let t=this.id??c(this,Et);h(this,et,`${Hr}${t}${qt}`),h(this,yt,`${Hr}${t}${jt}`),performance.mark(c(this,et)),h(this,F,Y()),gn(c(this,F)),h(this,wt,c(this,F).Log.module(Ne)),this.addEventListener(he,this.handleQuantitySelection),this.addEventListener(me,this.handleAddonAndQuantityUpdate),this.addEventListener(He,this.handleMerchOfferSelectReady),this.addEventListener(at,this.handleAemFragmentEvents),this.addEventListener(nt,this.handleAemFragmentEvents),this.addEventListener("change",this.changeHandler),this.aemFragment||setTimeout(()=>this.checkReady(),0)}disconnectedCallback(){super.disconnectedCallback(),this.variantLayout?.disconnectedCallbackHook(),this.removeEventListener(he,this.handleQuantitySelection),this.removeEventListener(at,this.handleAemFragmentEvents),this.removeEventListener(nt,this.handleAemFragmentEvents),this.removeEventListener("change",this.changeHandler),this.removeEventListener(me,this.handleAddonAndQuantityUpdate)}async handleAemFragmentEvents(t){var r;if(this.isConnected&&(t.type===at&&w(this,E,tt).call(this,"AEM fragment cannot be loaded"),t.type===nt&&(this.failed=!1,t.target.nodeName==="AEM-FRAGMENT"))){let n=t.detail;try{c(this,I)||h(this,rt,new Promise(a=>{h(this,I,a)})),Br(n,this)}catch(a){w(this,E,tt).call(this,`hydration has failed: ${a.message}`)}finally{(r=c(this,I))==null||r.call(this),h(this,I,void 0)}this.checkReady()}}async checkReady(){if(!this.isConnected)return;c(this,rt)&&(await c(this,rt),h(this,rt,void 0)),this.variantLayoutPromise&&(await this.variantLayoutPromise,this.variantLayoutPromise=void 0);let t=new Promise(i=>setTimeout(()=>i("timeout"),Me));if(this.aemFragment){let i=await Promise.race([this.aemFragment.updateComplete,t]);if(i===!1||i==="timeout"){let s=i==="timeout"?`AEM fragment was not resolved within ${Me} timeout`:"AEM fragment cannot be loaded";w(this,E,tt).call(this,s,{},!1);return}}let r=[...this.querySelectorAll(Be)],n=Promise.all(r.map(i=>i.onceSettled().catch(()=>i))).then(i=>i.every(s=>s.classList.contains("placeholder-resolved"))),a=await Promise.race([n,t]);if(a===!0){this.measure=performance.measure(c(this,yt),c(this,et));let i={...this.aemFragment?.fetchInfo,...c(this,F).duration,measure:it(this.measure)};return this.dispatchEvent(new CustomEvent(Ge,{bubbles:!0,composed:!0,detail:i})),this}else{this.measure=performance.measure(c(this,yt),c(this,et));let i={measure:it(this.measure),...c(this,F).duration};a==="timeout"?w(this,E,tt).call(this,`Contains offers that were not resolved within ${Me} timeout`,i):w(this,E,tt).call(this,"Contains unresolved offers",i)}}get aemFragment(){return this.querySelector("aem-fragment")}get addon(){return this.querySelector("merch-addon")}get quantitySelect(){return this.querySelector("merch-quantity-select")}get addonCheckbox(){return this.querySelector("merch-addon")}displayFooterElementsInColumn(){if(!this.classList.contains("product"))return;let t=this.shadowRoot.querySelector(".secure-transaction-label");(this.footerSlot?.querySelectorAll(U)).length===2&&t&&t.parentElement.classList.add("footer-column")}handleMerchOfferSelectReady(){this.offerSelect&&!this.offerSelect.planType||this.displayFooterElementsInColumn()}get dynamicPrice(){return this.querySelector('[slot="price"]')}handleAddonAndQuantityUpdate({detail:{id:t,items:r}}){if(!t||!r?.length||this.closest('[role="tabpanel"][hidden="true"]'))return;let a=this.checkoutLinks.find(g=>g.getAttribute("data-modal-id")===t);if(!a)return;let s=new URL(a.getAttribute("href")).searchParams.get("pa"),d=r.find(g=>g.productArrangementCode===s)?.quantity,p=!!r.find(g=>g.productArrangementCode!==s);if(d&&this.quantitySelect?.dispatchEvent(new CustomEvent(je,{detail:{quantity:d},bubbles:!0,composed:!0})),this.addonCheckbox&&this.addonCheckbox.checked!==p){this.toggleStockOffer({target:this.addonCheckbox});let g=new Event("change",{bubbles:!0,cancelable:!0});Object.defineProperty(g,"target",{writable:!1,value:{checked:p}}),this.addonCheckbox.handleChange(g)}}get prices(){return Array.from(this.querySelectorAll(f))}get promoPrice(){if(!this.querySelector("span.price-strikethrough"))return;let t=this.querySelector(".price.price-alternative");if(t||(t=this.querySelector(`${f}[data-template="price"] > span`)),!!t)return t=t.innerText,t}get regularPrice(){return c(this,E,ce)?.innerText}get promotionCode(){let t=[...this.querySelectorAll(`${f}[data-promotion-code],${U}[data-promotion-code]`)].map(n=>n.dataset.promotionCode),r=[...new Set(t)];return r.length>1&&c(this,wt)?.warn(`Multiple different promotion codes found: ${r.join(", ")}`),t[0]}get annualPrice(){return this.querySelector(`${f}[data-template="price"] > .price.price-annual`)?.innerText}get promoText(){}get taxText(){return(c(this,E,jr)??c(this,E,ce))?.querySelector("span.price-tax-inclusivity")?.textContent?.trim()||void 0}get recurrenceText(){return c(this,E,ce)?.querySelector("span.price-recurrence")?.textContent?.trim()}get planTypeText(){return this.querySelector('[is="inline-price"][data-template="legal"] span.price-plan-type')?.textContent?.trim()}get seeTermsInfo(){let t=this.querySelector('a[is="upt-link"]');if(t)return w(this,E,se).call(this,t)}get renewalText(){return this.querySelector("span.renewal-text")?.textContent?.trim()}get promoDurationText(){return this.querySelector("span.promo-duration-text")?.textContent?.trim()}get ctas(){return Array.from(this.querySelector('[slot="ctas"], [slot="footer"]')?.querySelectorAll(`${U}, a`))}get primaryCta(){return w(this,E,se).call(this,this.ctas.find(t=>t.variant==="accent"||t.matches(".spectrum-Button--accent,.con-button.blue")))}get secondaryCta(){return w(this,E,se).call(this,this.ctas.find(t=>t.variant!=="accent"&&!t.matches(".spectrum-Button--accent,.con-button.blue")))}};yt=new WeakMap,Et=new WeakMap,wt=new WeakMap,F=new WeakMap,et=new WeakMap,I=new WeakMap,rt=new WeakMap,E=new WeakSet,tt=function(t,r={},n=!0){if(!this.isConnected)return;let i=this.aemFragment?.getAttribute("fragment");i=`[${i}]`;let s={...this.aemFragment.fetchInfo,...c(this,F).duration,...r,message:t};c(this,wt).error(`merch-card${i}: ${t}`,s),this.failed=!0,n&&this.dispatchEvent(new CustomEvent(Ve,{bubbles:!0,composed:!0,detail:s}))},ce=function(){return this.querySelector("span.price-strikethrough")??this.querySelector(`${f}[data-template="price"] > span`)},jr=function(){return this.querySelector(`${f}[data-template="legal"]`)},se=function(t){if(t)return{text:t.innerText.trim(),analyticsId:t.dataset.analyticsId,href:t.getAttribute("href")??t.dataset.href}},l(G,"properties",{id:{type:String,attribute:"id",reflect:!0},name:{type:String,attribute:"name",reflect:!0},variant:{type:String,reflect:!0},size:{type:String,attribute:"size",reflect:!0},badgeColor:{type:String,attribute:"badge-color",reflect:!0},borderColor:{type:String,attribute:"border-color",reflect:!0},backgroundColor:{type:String,attribute:"background-color",reflect:!0},badgeBackgroundColor:{type:String,attribute:"badge-background-color",reflect:!0},backgroundImage:{type:String,attribute:"background-image",reflect:!0},badgeText:{type:String,attribute:"badge-text"},actionMenu:{type:Boolean,attribute:"action-menu"},actionMenuLabel:{type:String,attribute:"action-menu-label"},customHr:{type:Boolean,attribute:"custom-hr"},consonant:{type:Boolean,attribute:"consonant"},failed:{type:Boolean,attribute:"failed",reflect:!0},spectrum:{type:String,attribute:"spectrum"},detailBg:{type:String,attribute:"detail-bg"},secureLabel:{type:String,attribute:"secure-label"},checkboxLabel:{type:String,attribute:"checkbox-label"},addonTitle:{type:String,attribute:"addon-title"},addonOffers:{type:Object,attribute:"addon-offers"},selected:{type:Boolean,attribute:"aria-selected",reflect:!0},storageOption:{type:String,attribute:"storage",reflect:!0},planType:{type:String,attribute:"plan-type",reflect:!0},settings:{type:Object,attribute:!1},stockOfferOsis:{type:Object,attribute:"stock-offer-osis",converter:{fromAttribute:t=>{if(!t)return;let[r,n,a]=t.split(",");return{PUF:r,ABM:n,M2M:a}}}},filters:{type:String,reflect:!0,converter:{fromAttribute:t=>Object.fromEntries(t.split(",").map(r=>{let[n,a,i]=r.split(":"),s=Number(a);return[n,{order:isNaN(s)?void 0:s,size:i}]})),toAttribute:t=>Object.entries(t).map(([r,{order:n,size:a}])=>[r,n,a].filter(i=>i!=null).join(":")).join(",")}},types:{type:String,attribute:"types",reflect:!0},merchOffer:{type:Object},analyticsId:{type:String,attribute:ie,reflect:!0},loading:{type:String},priceLiterals:{type:Object}}),l(G,"styles",[De,...Fe()]),l(G,"registerVariant",C),l(G,"getCollectionOptions",fr),l(G,"getFragmentMapping",Yt);customElements.define(Ne,G);export{G as MerchCard};
